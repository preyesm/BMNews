...
public class CustomListAutoCompletionAdapter extends ArrayAdapter {
    ...
    public CustomListAutoCompletionAdapter(Context context, int resource, List<String> storeDataLst) {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        if (position % 2 == 0) {
            strName.setBackgroundColor(mContext.getResources().getColor(R.color.profile_grey));
        } else {
            strName.setBackgroundColor(mContext.getResources().getColor(R.color.white));
        }
